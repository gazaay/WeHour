...
* [Solution Overview](core-concepts/solution-overview.md)
* [Value Proposition](core-concepts/value-proposition.md)

## 🪙 Tokenomics
* [Dual Token Model](tokenomics/dual-token-model.md)
* [VH$ (WeHours Token)](tokenomics/vh-token.md)
* [VB$ (Badge Token)](tokenomics/vb-token.md)
* [Token Correlations](tokenomics/token-correlations.md)
* [Cross-Chain Architecture](tokenomics/cross-chain-architecture.md)
* [Economic Model](tokenomics/economic-model.md)

## 🏗️ Technical Architecture
* [System Overview](technical-architecture/system-overview.md)
* [Blockchain Infrastructure](technical-architecture/blockchain-infrastructure.md)
* [Smart Contracts](technical-architecture/smart-contracts.md)
* [Cross-Chain Implementation](technical-architecture/cross-chain-implementation.md)
